...
class MCPConfig(BaseModel):
    ...
    ssl_ca_bundle: str | None = Field(default=None, description="Path to CA bundle for SSL verification")
    allow_self_signed: bool = Field(default=False, description="Allow self-signed certificates (dev only)")
